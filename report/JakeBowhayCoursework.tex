...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\NoIndent{
			...
			as $f(0.5)=-0.4698$ and $f(1)=0.8012$. So the original equation 
			has two solutions.
		...
		$f(1)=0.1884$. So the original equation has two solutions.
		...
		\item Rearrnaging $4e^{-x^{2}/5} = cos(5x) + 2$ gives $f(x) = 
		4e^{-x^{2}/5} - cos(5x) - 2$.
